    ...
    public class PathView : ContentControl {
        ...
        public static readonly DependencyProperty PathProperty
            = DependencyProperty.Register("Path", typeof(string), typeof(PathView),
                new PropertyMetadata(DefPath, (o,_)=> ((PathView)o).UpdatePath()));
        ...
        public PathView() {
            ...
            grid.SetBinding(Panel.BackgroundProperty, new Binding("Background") { Source = this, Mode = BindingMode.OneWay });
